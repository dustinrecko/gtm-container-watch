...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_eventParameters":["list",["map","name","optinpage","value",["macro",19]],["map","name","acid","value",["macro",17]]],
      "vtp_measurementId":"G-CPVFPGFBP8",
      "vtp_enableUserProperties":true,
      "tag_id":71
    },{
      ...
      "once_per_event":true,
      "vtp_html":["template","\n\u003Cscript type=\"text\/gtmscript\"\u003E-1==document.location.href.search(\"appspot.com\")\u0026\u0026fbq(\"track\",\"Purchase\",{value:\"",["escape",["macro",22],7],"\",currency:\"USD\"});\u003C\/script\u003E\n\n"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":13
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Edocument.querySelector('input[name\\x3d\"fullname\"]').value=\"",["escape",["macro",29],7],"\";document.querySelector('input[name\\x3d\"email\"]').value=\"",["escape",["macro",28],7],"\";\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":256
  ...
  "rules":[
    [["if",0],["add",2,5,9,11,15,29,0,41,42,19,20,21,22,26]],
    [["if",1],["add",3,7,14,30,43]],
    [["if",2],["add",4,31]],
    [["if",3],["add",6]],
    [["if",4],["add",8]],
    [["if",5],["add",10]],
    ...
    [["if",0,13],["add",16,44]],
    [["if",0,14],["add",17,28,1,49]],
    [["if",15],["add",18]],
    [["if",0],["unless",16,17,18],["add",23]],
    [["if",12],["unless",19],["add",24,27]],
    [["if",12],["unless",20],["add",25]],
    [["if",21],["add",31]],
    [["if",15,16],["unless",22],["add",32]],
    [["if",0,23],["add",33]],
    [["if",0,24],["unless",25],["add",34]],
    [["if",0],["unless",26],["add",35]],
    [["if",15,27],["add",36]],
    [["if",0,28],["add",37]],
    ...
    [["if",33,34],["add",45]],
    [["if",0,35],["add",46]],
    [["if",15],["unless",36],["add",47]],
    [["if",12,37],["unless",38],["add",48]],
    [["if",0,39],["add",49]],
    [["if",0,40],["add",49]]]
}