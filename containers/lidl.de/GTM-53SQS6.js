...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_fieldsToSet":["list",["map","fieldName","anonymizeIp","value",["macro",10]],["map","fieldName","customTask","value",["macro",12]],["map","fieldName","cookieFlags","value","samesite=none;secure"]],
  ...
  "tags":[{
      ...
      "vtp_doubleClick":true,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","\u0026uid","value",["macro",18]],["map","fieldName","page","value",["macro",23]],["map","fieldName","referrer","value",["macro",26]]],
      ...
      "vtp_doubleClick":true,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","\u0026uid","value",["macro",18]],["map","fieldName","referrer","value",["macro",26]]],
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_fieldsToSet":["list",["map","name","cookie_flags","value","secure;samesite=none"]],
  ...
  "rules":[
    ...
    [["if",3,20],["add",7]],
    [["if",0,3,21],["add",7]],
    [["if",0,3,22],["add",7,16,52]],
    [["if",0,3,23],["add",7]],
    [["if",0,3,24],["add",7]],
    [["if",3,9,25],["add",7,16]],
    [["if",3,25,26],["add",7]],
    [["if",3,27],["add",7]],
    [["if",30,32,33],["unless",31],["add",8]],
    [["if",32,34,35],["add",8]],
    [["if",32,36,37],["add",8]],
    [["if",32,38,39],["add",8]],
    [["if",0,40,41],["add",10]],
    [["if",0,40,42,43,44],["add",10]],
    [["if",0,40,43,45],["unless",42],["add",11]],
    [["if",0,46,47],["add",12]],
    [["if",48,49],["add",13]],
    [["if",0,50],["add",14]],
    [["if",0,51,52],["add",14]],
    [["if",0,50,53],["add",15]],
    [["if",55,56],["unless",54],["add",18]],
    [["if",57,58],["add",19]],
    [["if",48,59,60],["add",20]],
    [["if",5,61],["add",21,22,23,25,26,27,28,29,34]],
    [["if",5,62],["add",24]],
    [["if",5,63],["add",30]],
    ...
    [["if",0,5,69],["add",46]],
    [["if",0,5,70],["add",46]],
    [["if",0,52,71],["add",47,53]],
    [["if",0,5,72],["add",48]],
    [["if",0,40,42,43,73],["add",49]],
    [["if",48,71,74],["add",50]],
    [["if",5,48],["add",50]],
    [["if",5,75],["add",0]],
